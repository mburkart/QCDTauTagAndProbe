...
slimmedJetsWithUserData = cms.EDProducer("PATJetUserDataEmbedder",
        ...
        userInts = cms.PSet(
            tightJetIdLepVeto = cms.InputTag("tightJetIdLepVeto"),
        ),
)
...
goodTaus = cms.EDFilter("PATTauRefSelector",
        ...
        cut = cms.string(
                ...
                '&& tauID("byVLooseIsolationMVArun2017v2DBoldDMwLT2017") > 0.5 ' # tau iso - NOTE: can as well use boolean discriminators with WP
